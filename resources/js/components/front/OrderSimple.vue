<template>
    <div class="container">
        <template v-if="views.step == 'selectPlan'">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div v-for="plan in plans" class="card card-plan mb-3">
                            ...
                            <div class="card-plan-buy">
                                <input v-model="order.plans.find(p => p.name == plan.name).quantity" type="number" min="0" class="form-control">
                    ...
                    <div class="col-12 col-lg-4">
                        <div v-if="order.plans" class="order-page-cart">
                            ...
                            <button @click="goToStep('completeOrder')" class="btn btn-primary btn-white" :disabled="!order.plans.reduce((a,curr) => a + curr.quantity, 0)">Оформить заказ</button>
                        </div>
                    </div>
                </div>
            </div>
